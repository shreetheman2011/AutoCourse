  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (docId && user) {
        ...
        let toolData = {};
        if (activeTool === "flashcards")
          toolData = { flashcards: data.flashcards };
        else if (activeTool === "quiz")
          toolData = { questions: data.questions };
      ...
      {step === "select" && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {tools.map((tool) => (
            ...
            >
              <div
                className={`w-16 h-16 ${tool.bg} ${tool.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform`}
              >
                <tool.icon size={32} />
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gray-100">
            ...
            >
              ...
              {/* Reusing Settings icon as Back for now, or arrow */}
            </button>
            <div>
              <h3 className="text-2xl font-bold text-gray-800">
                Customize {tools.find((t) => t.id === activeTool)?.name}
              </h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Extreme makes the AI build hard AP-level practice.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-2">
                How many questions/cards to generate.
              </p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              />
              <p className="text-xs text-gray-500 mt-2">
                Focus the content on specific areas of the document.
              </p>
            </div>
          </div>
